<?php 
      $trs = new lsp();
      $dataTransaksi = $trs->select("tbl_transaksi_terbaru");
      if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $dataDetail = $trs->edit("table_detailtransaksi","kd_transaksi",$id);
            $total  = $trs->selectSumWhere("table_transaksi","sub_total","kd_transaksi='$id'");
            $jumlah_barang = $trs->selectSumWhere("table_transaksi","jumlah","kd_transaksi='$id'");
      }
?>
<style>
      .col-sm-12{
